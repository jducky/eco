  ...
  dashboardPage(
    ...
    dashboardSidebar(
      ...
      sidebarMenu(
        ...
        menuItem("통합리포트",
          icon = icon("dashboard"), tabName = "report",
      ...
      tabItems(
        tabItem(
          ...
          fluidPage(div(
            ...
            div(
              style = "display: inline-block; font-size: 110%; color: white; margin-top: 10px; margin-right: 10px; float: right;",
              tags$ul(
                style = "list-style: none;", class = "title_ul",
          ...
          tabsetPanel(
            ...
            tabPanel(MR_Name,
              ...
              fluidRow(
                column(
                  ...
                  # uiOutput("MR_Info"),
                  box(
                    width = 12, title = "모형목록", status = "primary", height = "500", solidHeader = T, collapsible = TRUE,
                    div(
                      style = "overflow-y: scroll;height:400px;", width = "600",
                      uiOutput("MR_Info")
                    )
                  )
                ),
              ...
              fluidRow(
                box(
                  width = 8, title = "프로젝트 폴더 선택", status = "primary", solidHeader = F, collapsible = TRUE,
                    ...
                    mainPanel(
                      ...
                      fluidRow(
                        ...
                        column(
                          2,
                          tags$table(
                            style = "border: 1px solid black; padding: 1%; width: 150px; border-spacing: 10px;",

                            tags$tr(
                              style = "border: 1px solid black; padding: 1%; font-size: 120%;",
                        ...
                        column(
                          6, leafletOutput("SP_Map", width = "600", height = "600") %>% withSpinner(),
                ...
                tabPanel(
                  ...
                  sidebarLayout(
                    ...
                    mainPanel(
                      ...
                      column(
                        6, leafletOutput("SP_LOC_Map", width = "600", height = "600") %>% withSpinner(),
            ...
            tabPanel(LD_Name,
              ...
              sidebarLayout(
                sidebarPanel(
                  ...
                  sliderInput("LD_Project_year",
                    label = LD_Name_Year, min = 2000,
            ...
            tabPanel(CD_Name,
              ...
              sidebarLayout(
                sidebarPanel(
                  ...
                  sliderInput("CD_Project_year",
                    label = CD_Name_Year, min = 2000,
                    max = 2080, value = 2000, step = 10, sep = "",
                    animate = animationOptions(interval = 3000)
                  )
                ),
            ...
            tabPanel(SDM_Name,
              ...
              sidebarLayout(
                sidebarPanel(
                  ...
                  sliderInput("SDM_OU_Project_year",
                    label = SDM_Name_CD_Year_out, min = 2000,
                    max = 2080, value = 2000, step = 10, sep = "",
                    animate = animationOptions(interval = 10000)
                  ),

                  bsCollapse(
                    id = "ModelSelect", open = "Model",
                    bsCollapsePanel(
                      "Model",
                      # style = ST_Name,
            ...
            tabPanel(SS_Name,
              ...
              sidebarLayout(
                ...
                mainPanel(
                  fluidRow(
                    valueBoxOutput("SS_Value_WK"),
                    uiOutput("SS_Value_SP"),
                    uiOutput("SS_Value_YR")
                  ),
                  tabsetPanel(
                    tabPanel(
                      SS_Name_Out_ChangePlot,
                      tags$hr(),
            ...
            tabPanel(IS_Name,
              ...
              sidebarLayout(
                sidebarPanel(
                  ...
                  uiOutput("IS_VA_Dir_Folder"),
                  tags$hr(),

                  uiOutput("IS_AO_Species0"),
                  ...
                  sliderInput("IS_AO_Project_year",
                    label = IS_Name_CD_Year, min = 2000,
                    max = 2080, value = 2000, step = 10, sep = "",
                    animate = animationOptions(interval = 3000)
                  ),
                ...
                mainPanel(
                  fluidRow(
                    valueBoxOutput("IS_Value_WK2"),
                    valueBoxOutput("IS_Value_WK"),
                    valueBoxOutput("IS_Value_SP")
                  ),
                  tabsetPanel(
                    tabPanel(
                      IS_Name_Out_Species,
                      ...
                      bsCollapsePanel("Summary & Histogram",
                        style = ST_Name,
                        fluidRow(
                          column(4, verbatimTextOutput("IS_AO_SD_Summary")),
                          column(6, plotOutput("IS_AO_SD_Histogram"))
                        )
                      ),
        ...
        tabItem(
          ...
          fluidRow(
            tabBox(
              ...
              tabPanel("취약성지수",
                fluid = TRUE, icon = icon("pie-chart"),
                tags$hr(),
                sidebarLayout(
                  sidebarPanel(
                    width = 3,
