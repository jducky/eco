...
#                         ),
                        tags$hr(),
                            selectInput("SE_Language", SE_Language_Name,
                            choices = c("English" = "option1",
                                        "Korean" = "option2"),
                                       selected = "option1"
                             ),
                         tags$hr(),
                         shinyDirButton("SE_Dir_In", "Chose directory", "Upload")
                         
                         ),

                      mainPanel(
                          h5("Working Directory"),
                          verbatimTextOutput("SE_Dir_Out", placeholder = TRUE), br()
                      )
